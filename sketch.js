...
function preload()
{
  ...
  mt_img = loadAnimation("empty.png");
...
function setup() 
{
  ...
  starry = createSprite(50,20,30,30);
  starry.scale = 0.2
  starry.addAnimation("mt",mt_img);
  starry.addAnimation("oneStar",oneStarIMG);
  starry.addAnimation("twoStar",twoStarIMG);
  starry.changeAnimation("mt");
  ...
  star.addImage("starry",star_img);
  star.scale = 0.02;

  star2 = createSprite(50,370,20,20);
  star2.addImage("starry",star_img);
  star2.scale = 0.02;
...
function draw() 
{
  ...
  if(collide(fruit,star,20)==true){
     star.visible=false;
     starry.changeAnimation("oneStar");
  }

  if(collide(fruit,star2,20)==true){
    star2.visible=false;
    starry.changeAnimation("twoStar");
 }
